<?php
class ControllerExtensionServices extends Controller {
    ...
    public function index() {
        ...
        $this->language->load('extension/services/post');
    ...
    protected function getPostList() {
        ...
        $this->load->model('extension/services/setting');
        $settings = $this->model_extension_services_setting->settings();
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/services', 'token=' . $this->session->data['token'] . $url, 'SSL')
        );

        // Buttons URL
        $data['post_create_link'] = $this->url->link('extension/services/post_create', 'token=' . $this->session->data['token'] . $url, 'SSL');
        $data['post_edit_link'] = $this->url->link('extension/services/post_edit', 'token=' . $this->session->data['token'] . $url, 'SSL');
        $data['post_delete_multiple'] = $this->url->link('extension/services/post_delete_multiple', 'token=' . $this->session->data['token'] . $url, 'SSL');
        $data['post_delete_link'] = $this->url->link('extension/services/post_delete', 'token=' . $this->session->data['token'] . $url, 'SSL');
        ...
        $this->load->model('extension/services/post');

        $total_post = $this->model_extension_services_post->getTotalPost($filter_data);
        $posts = $this->model_extension_services_post->getPosts($filter_data);
        ...
        $data['sort_title'] = $this->url->link('extension/services', 'token=' . $this->session->data['token'] . '&sort=pd.title' . $url, 'SSL');
        $data['sort_date'] = $this->url->link('extension/services', 'token=' . $this->session->data['token'] . '&sort=p.date_added' . $url, 'SSL');
        ...
        $pagination->url = $this->url->link('extension/services', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
        ...
        $this->response->setOutput($this->load->view('extension/services/post.tpl', $data));
    }

    public function post_create() {
        $this->language->load('extension/services/post_form');
        ...
        $this->data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/services', 'token=' . $this->session->data['token'], 'SSL')
        );

        $this->data['breadcrumbs'][] = array(
            'text' => $this->language->get('heading_title_create'),
            'href' => $this->url->link('extension/services/post_create', 'token=' . $this->session->data['token'], 'SSL')
        );
        ...
        $this->load->model('extension/services/postmodify');

        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            $post_id = $this->model_extension_services_postmodify->createPost($this->request->post);
            if($post_id) {
                $post_review_link = '<a target="_blink" href="' . HTTP_CATALOG . 'index.php?route=services/single&pid=' . $post_id . '">View</a>';
            ...
            $this->response->redirect($this->url->link('extension/services/post_edit', 'token=' . $this->session->data['token'] . $url, 'SSL'));
        }

        $this->data['action'] = $this->url->link('extension/services/post_create', 'token=' . $this->session->data['token'] . $url, 'SSL');
        $this->data['cancel'] = $this->url->link('extension/services', 'token=' . $this->session->data['token'] . $url, 'SSL');
    ...
    protected function check_post_id() {
        if(!isset($this->request->get['pid'])) {
            $this->response->redirect($this->url->link('extension/services', 'token=' . $this->session->data['token'], 'SSL'));
        }
    ...
    public function post_edit() {
        ...
        $this->data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/services/post_edit', 'token=' . $this->session->data['token'] . '&pid='. $this->pid, 'SSL')
        );
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            $this->model_extension_services_postmodify->editPost($this->pid, $this->request->post);

            $post_review_link = '<a target="_blink" href="' . HTTP_CATALOG . 'index.php?route=services/single&pid=' . $this->pid . '">View</a>';
            $this->session->data['success'] = $this->language->get('text_success_edit') . '&nbsp;|&nbsp;'.$post_review_link;

            $this->response->redirect($this->url->link('extension/services', 'token=' . $this->session->data['token'] . $url, 'SSL'));
        }

        $this->data['action'] = $this->url->link('extension/services/post_edit', 'token=' . $this->session->data['token'] . '&pid=' . $this->pid. $url, 'SSL');
        $this->data['cancel'] = $this->url->link('extension/services', 'token=' . $this->session->data['token'] . '&pid=' . $this->pid . $url, 'SSL');
    ...
    public function post_delete() {
        ...
        if ($this->pid && $this->validateDelete()) {
            if($this->model_extension_services_postmodify->deletePost($this->pid)) {
                $this->session->data['success'] = $this->language->get('text_success_delete');
            } else {
                $this->session->data['error_warning'] = $this->language->get('text_error_delete');
            }

            $this->response->redirect($this->url->link('extension/services', 'token=' . $this->session->data['token'] . '&pid=' . $this->pid . $url, 'SSL'));
        }
    ...
    protected function getForm() {
        ...
        if ($this->pid && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
            $post_info = $this->model_extension_services_post->getPost($this->pid);
        }
        ...
        if (isset($this->request->post['post_description'])) {
            ...
            $this->data['post_description'] = $this->model_extension_services_post->getPostDescriptions($this->pid);
        } else {
            $this->data['post_description'] = array();
        }

        $this->load->model('extension/services/category');

        if (isset($this->request->post['post_category'])) {
            $categories = $this->request->post['post_category'];
        } elseif ($this->pid) {
            $categories = $this->model_extension_services_post->getPostCategories($this->pid);
        } else {
            $categories = array();
        }
        ...
        foreach ($categories as $category_id) {
            $category_info = $this->model_extension_services_category->getCategory($category_id);
            if ($category_info) {
                $this->data['post_categories'][] = array(
        ...
        if (isset($this->request->post['post_filter'])) {
            ...
            $filters = $this->model_extension_services_post->getpostFilters($this->pid);
        } else {
            $filters = array();
        }
        ...
        if (isset($this->request->post['post_layout'])) {
            ...
            $this->data['post_layout'] = $this->model_extension_services_post->getPostLayouts($this->pid);
        } else {
        ...
        if (isset($this->request->post['post_store'])) {
            ...
            $this->data['post_store'] = $this->model_extension_services_post->getPostStores($this->pid);
        } else {
        ...
        if (isset($this->request->post['related_product'])) {
            ...
            $products = $this->model_extension_services_post->productByPostid(array('post_id'=>$this->pid));
        } else {
            $products = array();
        }
        ...
        if (isset($this->request->post['post_image'])) {
            ...
            $post_images = $this->model_extension_services_post->getPostImages($this->pid,'image');
        } else {
            $post_images = array();
        }
        ...
        $this->response->setOutput($this->load->view('extension/services/post_form.tpl', $this->data));
    }

    protected function validateForm() {
        if (!$this->user->hasPermission('modify', 'extension/services')) {
    ...
    public function category() {
        ...
        $this->language->load('extension/services/category');
    ...
    protected function getCatList() {
        ...
        $data['breadcrumbs'][] = array(
            'text' => $this->language->get('heading_title'),
            'href' => $this->url->link('extension/services/category', 'token=' . $this->session->data['token'] . $url, 'SSL')
        );

        // Buttons
        $data['category_create_link'] = $this->url->link('extension/services/category_create', 'token=' . $this->session->data['token'], 'SSL');
        $data['category_edit_link'] = $this->url->link('extension/services/category_edit', 'token=' . $this->session->data['token'], 'SSL');
        $data['category_delete_multiple'] = $this->url->link('extension/services/category_delete_multiple', 'token=' . $this->session->data['token'], 'SSL');
        $data['category_delete_link'] = $this->url->link('extension/services/category_delete', 'token=' . $this->session->data['token'], 'SSL');
        $data['token'] = $this->session->data['token'];
        ...
        $total_category = $this->model_extension_services_category->getTotalCategories($filter_data);
        $categories = $this->model_extension_services_category->getCategories($filter_data);
        ...
        $data['sort_name'] = $this->url->link('extension/services/category', 'token=' . $this->session->data['token'] . '&sort=cd1.name' . $url, 'SSL');
        $data['sort_order'] = $this->url->link('extension/services/category', 'token=' . $this->session->data['token'] . '&sort=c1.sort_order' . $url, 'SSL');
        $data['sort_status'] = $this->url->link('extension/services/category', 'token=' . $this->session->data['token'] . '&sort=c1.status' . $url, 'SSL');
        ...
        $pagination->page = $page;
        $pagination->limit = $limit;
        $pagination->url = $this->url->link('extension/services/category', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
        $data['pagination'] = $pagination->render();
        ...
        $this->response->setOutput($this->load->view('extension/services/category.tpl', $data));
    }

    public function category_create() {
        $this->language->load('extension/services/category_form');
        $this->document->setTitle($this->language->get('heading_title_create'));
        $this->data['heading_title'] = $this->language->get('heading_title_create');
        ...
        $this->data['breadcrumbs'][] = array(
            'text' => $this->language->get('base_title'),
            'href' => $this->url->link('extension/services/category', 'token=' . $this->session->data['token'], 'SSL')
        );

        $this->data['breadcrumbs'][] = array(
            'text' => $this->language->get('heading_title_create'),
            'href' => $this->url->link('extension/services/category_create', 'token=' . $this->session->data['token'], 'SSL')
        );
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validatecatForm()) {
            $this->load->model('extension/services/catmodify');
            $cid = $this->model_extension_services_catmodify->createCategory($this->request->post);
            if($cid) {
            ...
            $this->response->redirect($this->url->link('extension/services/category', 'token=' . $this->session->data['token'] . $url, 'SSL'));
        }

        $this->data['action'] = $this->url->link('extension/services/category_create', 'token=' . $this->session->data['token'] . $url, 'SSL');
        $this->data['cancel'] = $this->url->link('extension/services/category', 'token=' . $this->session->data['token'] . $url, 'SSL');
        $this->data['token'] = $this->session->data['token'];
    ...
    protected function check_category_id() {
        if(!isset($this->request->get['cid'])) {
            $this->response->redirect($this->url->link('extension/services/category', 'token=' . $this->session->data['token'], 'SSL'));
        }
    ...
    public function category_edit() {
        ...
        $this->data['breadcrumbs'][] = array(
            'text' => $this->language->get('heading_title_edit'),
            'href' => $this->url->link('extension/services/category_edit', 'token=' . $this->session->data['token'] . '&cid=' . $this->cid, 'SSL')
        );
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validatecatForm()) {
            ...
            $this->model_extension_services_catmodify->editCategory($this->cid, $this->request->post);

            $this->session->data['success'] = $this->language->get('text_success_edit');

            $this->response->redirect($this->url->link('extension/services/category_edit', 'token=' . $this->session->data['token'] . $url, 'SSL'));
        }

        $this->data['action'] = $this->url->link('extension/services/category_edit', 'token=' . $this->session->data['token'] . '&cid=' . $this->cid . $url, 'SSL');
        $this->data['cancel'] = $this->url->link('extension/services/category', 'token=' . $this->session->data['token'] . '&cid=' . $this->cid . $url, 'SSL');
        $this->data['token'] = $this->session->data['token'];
    ...
    public function category_delete() {
        ...
        if ($this->cid && $this->validateDelete()) {
            if($this->model_extension_services_catmodify->deleteCategory($this->cid)) {
                $this->session->data['success'] = $this->language->get('text_success_delete');
            } else {
                $this->session->data['error_warning'] = $this->language->get('text_error_delete');
            }
    ...
    public function category_autocomplete() {
        ...
        if (isset($this->request->get['filter_name'])) {
            ...
            $results = $this->model_extension_services_category->getCategories($filter_data);
    ...
    protected function getcategoryForm() {
        ...
        if ($this->cid && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
            $category_info = $this->model_extension_services_category->getCategory($this->cid);
        }
        ...
        if (isset($this->request->post['cat_description'])) {
            ...
            $this->data['cat_description'] = $this->model_extension_services_category->getCatDescriptions($this->cid);
        } else {
        ...
        if (isset($this->request->post['category_layout'])) {
            ...
            $this->data['category_layout'] = $this->model_extension_services_category->getCategoryLayouts($this->cid);
        } else {
        ...
        if (isset($this->request->post['category_filter'])) {
            ...
            $filters = $this->model_extension_services_category->getCategoryFilters($this->cid);
        } else {
            $filters = array();
        }
        ...
        if (isset($this->request->post['category_store'])) {
            ...
            $this->data['category_store'] = $this->model_extension_services_category->getCategoryStores($this->cid);
        } else {
        ...
        $this->response->setOutput($this->load->view('extension/services/category_form.tpl', $this->data));
    }
    ...
    protected function validatecatForm() {
        ...
        if (utf8_strlen($this->request->post['keyword']) > 0) {
            ...
            if ($url_alias_info && isset($this->request->get['cid']) && $url_alias_info['query'] != 'services_category_id=' . $this->request->get['cid']) {
                $this->data['form_error']['keyword'] = $this->language->get('error_keyword');
            }
    ...
    public function comment() {
        $this->language->load('extension/services/comment');
    ...
    protected function getCommentList() {
        ...
        $data['breadcrumbs'][] = array(
            'text' => $this->language->get('heading_title'),
            'href' => $this->url->link('extension/services/comment', 'token=' . $this->session->data['token'] . $url, 'SSL')
        );

        $data['comment_create_link'] = $this->url->link('extension/services/comment_create', 'token=' . $this->session->data['token'] . $url, 'SSL');
        $data['comment_edit_link'] = $this->url->link('extension/services/comment_edit', 'token=' . $this->session->data['token'] . $url, 'SSL');
        $data['comment_delete_link'] = $this->url->link('extension/services/comment_delete', 'token=' . $this->session->data['token'] . $url, 'SSL');
        $data['comment_delete_multiple'] = $this->url->link('extension/services/comment_delete_multiple', 'token=' . $this->session->data['token'] . $url, 'SSL');
        ...
        $this->load->model('extension/services/comment');

        $total_comment = $this->model_extension_services_comment->getTotalComments($filter_data);
        $data['comments'] = $this->model_extension_services_comment->getComments($filter_data,$where);
        ...
        $data['sort_date'] = $this->url->link('extension/services/comment', 'token=' . $this->session->data['token'] . '&sort=comment_date' . $url, 'SSL');
        $data['sort_status'] = $this->url->link('extension/services/comment', 'token=' . $this->session->data['token'] . '&sort=comment_approve' . $url, 'SSL');
        ...
        $pagination->page = $page;
        $pagination->limit = $limit;
        $pagination->url = $this->url->link('extension/services/comment', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
        $data['pagination'] = $pagination->render();
        ...
        $this->response->setOutput($this->load->view('extension/services/comment.tpl', $data));

    }

    protected function check_comment_id() {
        if(!isset($this->request->get['comment_id']) || empty($this->request->get['comment_id'])) {
            $this->response->redirect($this->url->link('extension/services/comment', 'token=' . $this->session->data['token'], 'SSL'));
        }
    }
    ...
    public function comment_edit() {
        ...
        $this->language->load('extension/services/comment_form');
        $this->document->setTitle($this->language->get('heading_title_edit'));
        $this->data['heading_title'] = $this->language->get('heading_title_edit');
        ...
        $this->data['breadcrumbs'][] = array(
            'text' => $this->language->get('base_title'),
            'href' => $this->url->link('extension/services/comment', 'token=' . $this->session->data['token'], 'SSL')
        );

        $this->data['breadcrumbs'][] = array(
            'text' => $this->language->get('heading_title_edit'),
            'href' => $this->url->link('extension/services/comment_edit', 'token=' . $this->session->data['token'] . '&comment_id=' . $this->comment_id, 'SSL')
        );
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validatecmtForm()) {
            $this->load->model('extension/services/cmtmodify');
            if($this->model_extension_services_cmtmodify->editComment($this->comment_id, $this->request->post)) {
                $this->session->data['success'] = $this->language->get('text_success_edit');
            } else {
                $this->session->data['error_warning'] = $this->language->get('text_error');
            }
            $this->response->redirect($this->url->link('extension/services/comment', 'token=' . $this->session->data['token'] . $url, 'SSL'));
        }

        $this->data['action'] = $this->url->link('extension/services/comment_edit', 'token=' . $this->session->data['token'] . '&comment_id=' . $this->comment_id . $url, 'SSL');
        $this->data['cancel'] = $this->url->link('extension/services/comment', 'token=' . $this->session->data['token'] . '&comment_id=' . $this->comment_id . $url, 'SSL');
        $this->data['token'] = $this->session->data['token'];

        $this->load->model('extension/services/comment');
        $this->data['comment'] = $this->model_extension_services_comment->getComment(array("c.comment_ID"=>"='".$this->comment_id."'"));
    ...
    public function comment_delete() {
        ...
        if ($this->comment_id && $this->validateDelete()) {
            if($this->model_extension_services_cmtmodify->deleteComment($this->comment_id)) {
                $this->session->data['success'] = $this->language->get('text_success_delete');
            } else {
                $this->session->data['error_warning'] = $this->language->get('text_error');
            }
    ...
    protected function getcmtForm() {
        ...
        $this->response->setOutput($this->load->view('extension/services/comment_form.tpl', $this->data));
    }
    ...
    public function setting() {
        ...
        $this->language->load('extension/services/setting');
        ...
        $this->data['breadcrumbs'][] = array(
            'text' => $this->language->get('heading_title'),
            'href' => $this->url->link('extension/services/setting', 'token=' . $this->session->data['token'], 'SSL')
        );
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validatesetForm()) {
            ...
            if($this->model_extension_services_setting->editSetting($this->request->post)) {
                $this->session->data['success'] = $this->language->get('text_success');
            } else {
                $this->session->data['error_warning'] = $this->language->get('text_error');
            }

            $this->response->redirect($this->url->link('extension/services/setting', 'token=' . $this->session->data['token'], 'SSL'));
        }

        // Buttons
        $this->data['action'] = $this->url->link('extension/services/setting', 'token=' . $this->session->data['token'] . '&action=edit', 'SSL');
        $this->data['cancel'] = $this->url->link('extension/services/setting', 'token=' . $this->session->data['token'] . '&action=cancel', 'SSL');
        ...
        $this->load->model('extension/services/setting');
        $total_setting = $this->model_extension_services_setting->total_settings();

        $general_setting = $this->model_extension_services_setting->setting_general();
        // $general = array();
        ...
        $this->data['setting_option'] = $this->model_extension_services_setting->settings(array("setting_keyword"=>"='option'"),"position");
        $this->data['setting_image'] = $this->model_extension_services_setting->settings(array("setting_keyword"=>"='image'"),"position");
        $this->data['setting_color'] = $this->model_extension_services_setting->settings(array("setting_keyword"=>"='color'"),"position");
        $this->data['setting_social'] = $this->model_extension_services_setting->settings(array("setting_keyword"=>"='social'"),"position");

        foreach ($this->data['setting_image'] as $image) {
            if($image['setting_name'] == 'services_logo') {
                $services_logo = $image['setting_value'];
            }

            if($image['setting_name'] == 'services_icon') {
                $services_icon = $image['setting_value'];
            }
        ...
        // print_r($services_logo); die();
        if (isset($services_logo)) {
            $this->data['image_logo'] = $services_logo;
        } else {
            $this->data['image_logo'] = '';
        }

        if (isset($services_icon)) {
            $this->data['image_icon'] = $services_icon;
        } else {
        ...
        if (isset($this->request->post['services_logo']) && is_file(DIR_IMAGE . $this->request->post['services_logo'])) {
            $this->data['services_logo'] = $this->model_tool_image->resize($this->request->post['services_logo'], $logo_width, $logo_height);
        } elseif (isset($services_logo) && is_file(DIR_IMAGE . $services_logo)) {
            $this->data['services_logo'] = $this->model_tool_image->resize($services_logo, $logo_width, $logo_height);
        } else {
            $this->data['services_logo'] = $this->model_tool_image->resize('no_image.png', $logo_width, $logo_height);
        }

        if (isset($this->request->post['services_icon']) && is_file(DIR_IMAGE . $this->request->post['services_icon'])) {
            $this->data['services_icon'] = $this->model_tool_image->resize($this->request->post['services_icon'], $icon_width, $icon_height);
        } elseif (isset($services_icon) && is_file(DIR_IMAGE . $services_icon)) {
            $this->data['services_icon'] = $this->model_tool_image->resize($services_icon, $icon_width, $icon_height);
        } else {
            $this->data['services_icon'] = $this->model_tool_image->resize('no_image.png', $icon_width, $icon_height);
        }
        ...
        $this->response->setOutput($this->load->view('extension/services/setting.tpl', $this->data));
    }
    ...
    public function help() {
        $this->language->load('extension/services/help');
        $this->document->setTitle($this->language->get('heading_title'));
        $this->data['heading_title'] = $this->language->get('heading_title');
        ...
        $this->data['breadcrumbs'][] = array(
            'text' => $this->language->get('heading_title'),
            'href' => $this->url->link('extension/services/help', 'token=' . $this->session->data['token'], 'SSL')
        );
        ...
        $this->response->setOutput($this->load->view('extension/services/help.tpl', $this->data));
    }
