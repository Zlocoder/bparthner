<?php
class ModelExtensionServicesComment extends Model {
	public function getComment($where=array()) {

		$sql = "SELECT ";
		$sql .= " * ";
		$sql .= "FROM " . DB_PREFIX . "services_comment c ";
		$sql .= "LEFT JOIN " . DB_PREFIX . "services_post p ON (c.comment_post_ID = p.ID) ";
	...
	public function getTotalComments($data = array()) {
		...
		$sql = "SELECT COUNT(DISTINCT c.comment_ID) AS total FROM " . DB_PREFIX . "services_comment c WHERE 1=1 ";
