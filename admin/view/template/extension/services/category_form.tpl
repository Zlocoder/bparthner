    ...
    <div class="panel panel-default" id="panel-parent">
      <div class="panel-body">  
          ...
          <ul class="nav nav-tabs" style="margin-bottom:10px; background: #F5F5F5; padding: 3px 3px 0;">
            <li class="active"><a href="<?php echo HTTP_SERVER; ?>index.php?route=extension/services/category&amp;token=<?php echo $token; ?>"><?php echo $category_menu; ?></a></li>
            ...
            <li><a href="<?php echo HTTP_SERVER; ?>index.php?route=extension/services/setting&amp;token=<?php echo $token; ?>"><?php echo $setting_menu; ?></a></li>
            <li><a href="<?php echo HTTP_SERVER; ?>index.php?route=extension/services/help&amp;token=<?php echo $token; ?>">
...
$('input[name=\'path\']').autocomplete({
  'source': function(request, response) {
    $.ajax({
      url: 'index.php?route=extension/services/category_autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
      dataType: 'json',
