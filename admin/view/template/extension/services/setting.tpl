    ...
    <div class="panel panel-default">
      <div class="panel-body">
        <ul style="margin-bottom:10px; background: #F5F5F5; padding: 3px 3px 0;" class="nav nav-tabs">
          <li><a href="<?php echo HTTP_SERVER; ?>index.php?route=extension/services/category&amp;token=<?php echo $token; ?>"><?php echo $category_menu; ?></a></li>
          <li><a href="<?php echo HTTP_SERVER; ?>index.php?route=extension/services&amp;token=<?php echo $token; ?>"><?php echo $post_menu; ?></a></li>
          <li><a href="<?php echo HTTP_SERVER; ?>index.php?route=extension/services/comment&amp;token=<?php echo $token; ?>"><?php echo $comment_menu; ?></a></li>
          <li class="active"><a href="<?php echo HTTP_SERVER; ?>index.php?route=extension/services/setting&amp;token=<?php echo $token; ?>"><?php echo $setting_menu; ?></a></li>
          <li><a href="<?php echo HTTP_SERVER; ?>index.php?route=extension/services/help&amp;token=<?php echo $token; ?>"><?php echo $help_menu; ?></a></li>
        </ul>
                          ...
                          <tr>
                            ...
                            <td width="83%">
                              ...
                              switch ($setting['setting_name']) {
                                case 'services_logo':
                                  ?>
                                    <a href="" id="services-logo" data-toggle="image" class="img-thumbnail"><img src="<?php echo $services_logo; ?>" alt="" title="" /></a>
                                    <input type="hidden" name="setting[<?php echo $setting['setting_id']; ?>][name]" value="<?php echo $image_logo; ?>" id="services_logo" />
                                  <?php
                                  break;
                                case 'services_icon':
                                  ?>
                                    <a href="" id="services-icon" data-toggle="image" class="img-thumbnail"><img src="<?php echo $services_icon; ?>" alt="" title="" /></a>
                                    <input type="hidden" name="setting[<?php echo $setting['setting_id']; ?>][name]" value="<?php echo $image_icon; ?>" id="services_icon" />
                                  <?php
                                  break;
