...
class ControllerModuleServicesTabs extends Controller {
    public function index($settings) {
        ...
        $data['recent_posts'] = $this->model_services_post->getPosts($filter_data_recent);
        $data['popular_posts'] = $this->model_services_post->getPosts($filter_data_popular);
        ...
        if (isset($parts[0])) {
            $data['services_tabs_id'] = $parts[0];
        } else {
            $data['services_tabs_id'] = 0;
        }
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/services_tabs.tpl')) {
            return $this->load->view($this->config->get('config_template') . '/template/module/services_tabs.tpl', $data);
        } else {
            return $this->load->view('default/template/module/services_tabs.tpl', $data);
        }
    }
}