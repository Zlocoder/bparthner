...
<div class="panel-body">
    <form id="form" class="form" action="<?php echo HTTP_SERVER; ?>index.php?route=module/services_comment/submit&amp;pid=<?php echo $_GET['pid']; ?>" method="post">
...
<script type="text/javascript"><!--
        $('#submitxx').on('click', function() {
            ...
            $.ajax({
                url: "index.php?route=module/services_comment/submit&pid=<?php echo $_GET['pid']; ?>",
                type: 'post',
                dataType: 'json',
                ...
                success: function(json) {
                    ...
                    if (json['success']) {
                        $('#services-comment').before('<div class="alert alert-success"><i class="fa fa-check-circle"></i> ' + json['success'] + '</div>');
                        ...
                        $('#commentList').load('index.php?route=services/single&pid=<?php echo $_GET['pid']; ?> #commentList');

                        var position = $('#services-comment').offset().top - 80;
