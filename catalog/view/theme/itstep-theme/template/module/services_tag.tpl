...
<div class="widget services-tags">
    ...
    <div class="widget-body content">
        ...
        <ul class="weighted" style="font-size: 50%;display: none;" id="weightTags0">
            ...
            <?php if(isset($tags[$i])) :	 
    				...
    				?>
            <li><a href="<?php echo HTTP_SERVER; ?>index.php?route=services/tag&amp;tag=<?php echo $tags[$i]; ?>" title="" data-weight="<?php echo $data_weight; ?>" style="font-size: 3.16ex"><?php echo ucfirst($tags[$i]); ?></a>
            </li>
            <?php endif; ?>
            <?php endfor; ?>
        </ul>
...
<div class="widget services-tags">
    ...
    <div class="widget-body content">
        ...
        <ul class="list-unstyled">
            ...
            <li class="<?php echo ($tags[$i] == $selected) ? 'active' : null; ?>"><a style="font-size: <?php echo $random_fontsize; ?>px" href="<?php echo HTTP_SERVER; ?>index.php?route=services/tag&amp;tag=<?php echo $tags[$i]; ?>" title="" data-weight="<?php echo $data_weight; ?>"><?php echo ucfirst($tags[$i]); ?></a>
            </li>
            <?php endif; ?>
            <?php endfor; ?>
        </ul>
