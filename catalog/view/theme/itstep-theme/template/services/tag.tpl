...
<div id="services-content" id="services">
  
  <?php if(count($breadcrumbs)) : ?>
  <div id="services-breadcrumb">
    <div class="container">
      <div class="row">
        <div class="col-sm-12">
          <ul class="breadcrumb">
  ...
  <div id="services-topcontent" class="module-content">
      <div class="container">
  ...
  <div class="row">
          ...
          <ul class="post-list">
            ...
            foreach ($posts as $post) : ?>
              <li class="post">
                ...
                <div class="readmore">
                  <a href="<?php echo HTTP_SERVER; ?>index.php?route=services/single&amp;pid=<?php echo $post['ID']; ?>"><?php echo $text_readmore; ?></a>
                </div>
    ...
    <div id="services-bottomcontent" class="module-content">
        <div class="container">
